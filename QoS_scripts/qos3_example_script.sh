...
srun -N 4 -n 64 ior-3.3.0/src/mdtest -F -C -T -r -n 16384 -d $SCRATCH/directory_1 -N 16  &

srun -N 4 -n 64 ior-3.3.0/src/mdtest -F -C -T -r -n 16384 -d $SCRATCH/directory_2 -N 16  &
...
srun -N 4 -n 64 ior-3.3.0/src/mdtest -F -C -T -r -n 16384 -d $SCRATCH/directory_3 -N 16  &
...
srun -N 4 -n 64 ior-3.3.0/src/mdtest -F -C -T -r -n 16384 -d $SCRATCH/directory_4 -N 16  &
...
srun -N 4 -n 64 ior-3.3.0/src/mdtest -F -C -T -r -n 16384 -d $SCRATCH/directory_5 -N 16  &
