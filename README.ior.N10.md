...
Write bandwidth has slightly higher importance for this test,
so if the highest observed read rate came from a different run than
the highest observed write rate,
report the results from the run with the highest write rate.
